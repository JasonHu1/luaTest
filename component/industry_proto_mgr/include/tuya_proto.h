    ...
    public:
        ...
        int send(void){
            ...
            strcpy(dp.value.dp_str,m_valuestr.c_str());
             PR_DEBUG("dp.value.dp_str=%s",dp.value.dp_str);
        }
        int sendPtr(void){
            PR_ERR("111");
             PR_DEBUG("dp.value.m_dpid=%d",pDpArray[0].dpid);
             PR_DEBUG("dp.value.m_dpid=%d",pDpArray[1].dpid);
             PR_DEBUG("dp.value.m_dpid=%d",pDpArray[2].dpid);
        }
